...
var token;
(0, _mocha.describe)('GET api/v1/messages/:id', function () {
  ...
  (0, _mocha.it)('it should return an error if token cannot be verifed', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages/1').set('authorization', 'Bearer jxxxxxxxxxxxxnns66s').end(function (err, res) {
  ...
  (0, _mocha.it)('it should return an error if token is not provided', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages/1').end(function (err, res) {
  ...
  (0, _mocha.it)('it gets a message', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages/1').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
  ...
  (0, _mocha.it)('it throws error if no user\'s message with such id is found', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages/1001').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
      if (!res.body.data) {
