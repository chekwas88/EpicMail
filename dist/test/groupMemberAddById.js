...
var token;
(0, _mocha.describe)('Post /api/v1/groups/:groupid/users/:id', function () {
  ...
  (0, _mocha.it)('it should return an error if token cannot be verifed', function (done) {
    (0, _chai.request)(_app["default"]).post('/api/v1/groups/1/users/3').set('authorization', 'Bearer jxxxxxxxxxxxxnns66s').end(function (err, res) {
  ...
  (0, _mocha.it)('it should return an error if token is not provided', function (done) {
    (0, _chai.request)(_app["default"]).post('/api/v1/groups/1/users/3').end(function (err, res) {
  ...
  (0, _mocha.it)('it adds  member(s) to a group', function (done) {
    (0, _chai.request)(_app["default"]).post('/api/v1/groups/1/users/3').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
