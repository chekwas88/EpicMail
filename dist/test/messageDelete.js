...
(0, _mocha.describe)('GET api/v1/messages/:id', () => {
  ...
  (0, _mocha.it)('it should return an error if token cannot be verifed', done => {
    (0, _chai.request)(_app2.default).delete('/api/v1/messages/1').set('authorization', 'Bearer jxxxxxxxxxxxxnns66s').end((err, res) => {
  ...
  (0, _mocha.it)('it should return an error if token is not provided', done => {
    (0, _chai.request)(_app2.default).delete('/api/v1/messages/1').end((err, res) => {
  ...
  (0, _mocha.it)('it throws not found error a messages', done => {
    (0, _chai.request)(_app2.default).delete('/api/v1/messages/1001').set('authorization', `Bearer ${token}`).end((err, res) => {
      if (!res.body.data) {
