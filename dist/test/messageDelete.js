...
(0, _mocha.describe)('GET api/v1/messages/:id', function () {
  ...
  (0, _mocha.it)('it should return an error if token cannot be verifed', function (done) {
    (0, _chai.request)(_app["default"])["delete"]('/api/v1/messages/1').set('authorization', 'Bearer jxxxxxxxxxxxxnns66s').end(function (err, res) {
  ...
  (0, _mocha.it)('it should return an error if token is not provided', function (done) {
    (0, _chai.request)(_app["default"])["delete"]('/api/v1/messages/1').end(function (err, res) {
  ...
  (0, _mocha.it)('it deletes a messages', function (done) {
    (0, _chai.request)(_app["default"])["delete"]('/api/v1/messages/1').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
  ...
  (0, _mocha.it)('it throws not found error a messages', function (done) {
    (0, _chai.request)(_app["default"])["delete"]('/api/v1/messages/1001').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
      if (!res.body.data) {
