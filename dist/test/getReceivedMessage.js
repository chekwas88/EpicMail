...
var token;
(0, _mocha.describe)('GET api/v1/messages', function () {
  ...
  (0, _mocha.it)('it should return an error if token cannot be verifed', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages').set('authorization', 'Bearer jxxxxxxxxxxxxnns66s').end(function (err, res) {
  ...
  (0, _mocha.it)('it should return an error if token is not provided', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages').end(function (err, res) {
  ...
  (0, _mocha.it)('it gets all received messages', function (done) {
    (0, _chai.request)(_app["default"]).get('/api/v1/messages').set('authorization', "Bearer ".concat(token)).end(function (err, res) {
